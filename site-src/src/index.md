...
<div class="mr-home">
    ...
    <div class="mr-hero-grid">
      <div>
        ...
        <p class="mr-page-summary">
          Embed a CP core inside your own Java service when you need strongly
          consistent metadata, coordination, or lock semantics.
        </p>
  ...
  <section class="mr-proof-strip">
    <a class="mr-proof" href="https://central.sonatype.com/artifact/io.microraft/microraft"><span class="fa-solid fa-cube mr-proof-icon" aria-hidden="true"></span><span>Maven Central</span></a>
    <a class="mr-proof" href="https://javadoc.io/doc/io.microraft/microraft"><span class="fa-solid fa-code mr-proof-icon" aria-hidden="true"></span><span>Javadoc</span></a>
    <a class="mr-proof" href="https://github.com/MicroRaft/MicroRaft"><span class="fa-brands fa-github mr-proof-icon" aria-hidden="true"></span><span>GitHub</span></a>
    <a class="mr-proof" href="/docs/production-checklist/"><span class="fa-solid fa-shield-halved mr-proof-icon" aria-hidden="true"></span><span>Production guidance</span></a>
  </section>
      ...
      <div class="mr-tab-panel is-active" role="tabpanel" data-tab-panel="getting-started">
        <div class="mr-tab-panel-grid">
          <a class="mr-card mr-home-link-card" href="/docs/setup/">
            ...
            <p>Start with the local tutorial test to see leader election, quorum, and commit flow in one place.</p>
            <pre class="mr-code-block"><code>./gradlew :microraft-tutorial:test \
  --tests io.microraft.tutorial.OperationCommitTest</code></pre>
          ...
          <a class="mr-card mr-home-link-card" href="/docs/tutorial-building-an-atomic-register/">
            ...
            <p>Continue with the atomic register walkthrough to see the smallest practical integration shape.</p>
      ...
      <div class="mr-tab-panel" role="tabpanel" hidden data-tab-panel="evaluate">
        <div class="mr-tab-panel-grid">
          <a class="mr-card mr-home-link-card" href="/docs/why-microraft/">
            ...
            <p>Read this first to decide whether an embeddable Raft core is the right shape for your system.</p>
          ...
          <a class="mr-card mr-home-link-card" href="/docs/use-cases/">
            ...
            <p>Evaluate MicroRaft through metadata stores, lock services, and coordination systems instead of protocol theory.</p>
      ...
      <div class="mr-tab-panel" role="tabpanel" hidden data-tab-panel="operate">
        <div class="mr-tab-panel-grid">
          <a class="mr-card mr-home-link-card" href="/docs/production-checklist/">
            ...
            <p>Use this once the local flow is clear and you need a practical rollout checklist.</p>
          ...
          <a class="mr-card mr-home-link-card" href="/docs/resiliency-and-fault-tolerance/">
            ...
            <p>Check follower loss, recovery catch-up, quorum behavior, and leader changes before trusting it in production.</p>
            <span class="mr-card-cta">Open guide</span>
          </a>
        </div>
      </div>
  ...
  <section class="mr-callout">
    ...
    <div class="mr-card-grid">
      ...
      <article>
        ...
        <p>Keep control over persistence, networking, serialization, state machine logic, and threading.</p>
      </article>
      <article>
        <h3>Operationally serious</h3>
        <p>Snapshotting, membership changes, quorum-aware queries, leadership transfer, and metrics support are already built in.</p>
      </article>
    </div>
  </section>
  ...
  <section>
    ...
    <div class="mr-steps-grid">
      <a class="mr-step mr-home-link-card" href="/docs/setup/">
        ...
        <p>Verify the local 3-node example.</p>
        <span class="mr-card-cta">Open guide</span>
      </a>
