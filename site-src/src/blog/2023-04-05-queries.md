...
description: "Understand query execution in MicroRaft, including linearizable, lease-based, and eventual consistency tradeoffs for Java Raft systems."
keywords: "raft queries java, microraft queries, linearizable query raft, leader lease raft, java raft consistency"
